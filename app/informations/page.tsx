  ...
  return (
    <section className="mx-auto max-w-2xl min-h-[calc(100vh-var(--nav-h,64px))] grid place-items-center px-4 text-center">
      <div>
        ...
        <h2 className="mt-2 text-sm text-neutral-700 leading-relaxed">
        ...
        <h3 className="mt-10 text-sm font-medium tracking-widest text-neutral-900">
          GENERAL INQUIRIES
        </h3>
        <a
          href="mailto:contact@gilanselmi.com"
          className="underline hover:opacity-80 transition text-neutral-900"
        >
          contact@gilanselmi.com
        </a>
        <h3 className="mt-5 text-sm font-medium text-neutral-700">
